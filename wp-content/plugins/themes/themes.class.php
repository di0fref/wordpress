...
class fref_Themes
{
	...
	public function display($content)
	{
		...
		foreach ($this->themes as $theme) {
			...
			<article class='post-636 post type-post status-publish format-standard hentry category-plugins tag-jetpack tag-widgets media odd'>
					...
					<div class='col-md-4'>
						<div class='media-body'>
							...
							<p>Updated: " . date("F jS, Y", strtotime($theme->date_updated)) . "<br>Version: $theme->version</p>
			...
			/*
			$thumb = "<img class='thumbnail' src='".IMAGE_URL."$theme->thumb&amp;height=".get_option("themes_options_thumb_height")."&amp;width=".get_option("themes_options_thumb_width")."' alt='image' />";
		...
		return preg_replace("|<!--THEMES-->|", $this->output, $p);
	}
